...
class TestTodolistApp(unittest.TestCase):
    ...
    def test_invalidInput(self, mock_inputs):
        ...
        app = todolistApp.TodolistApp()
        app.start()
        self.assertTrue("Error: Command is not valid." in capturedOutput.getvalue())
        sys.stdout = sys.__stdout__
    ...
    def test_insertAndSearch(self, mock_inputs):
        ...
        app = todolistApp.TodolistApp()
        app.start()
        self.assertTrue("Task  task1  is found at index  0" in capturedOutput.getvalue())
        sys.stdout = sys.__stdout__
    ...
    def test_insertAtPosition(self, mock_inputs):
        ...
        app = todolistApp.TodolistApp()
        app.start()
        self.assertTrue("Task  task1  is inserted at index  0" in capturedOutput.getvalue())
        sys.stdout = sys.__stdout__
    ...
    def test_removeAt(self, mock_inputs):
        ...
        app = todolistApp.TodolistApp()
        app.start()
        self.assertTrue("Task  task1  located at index  0  is removed" in capturedOutput.getvalue())
        sys.stdout = sys.__stdout__
    ...
    def test_removeAt(self, mock_inputs):
        ...
        app = todolistApp.TodolistApp()
        app.start()
        self.assertTrue("Task  taskX  is inserted after task  task1" in capturedOutput.getvalue())
        sys.stdout = sys.__stdout__
